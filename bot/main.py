...
#embed(s):
    ...
    if message.content.lower().strip().startswith(';roles3'):
       ...
       embed_m.set_image(url="https://cdn.discordapp.com/attachments/957051422074081320/969202635527847946/Color-wheel-light-color-spectrum-removebg-preview.png")                
       await message.channel.send(embed=embed_m)
       time.sleep(2)
       await message.delete()
