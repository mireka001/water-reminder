...
async def on_message(message):
    ...
    if message.content.lower().strip().startswith('.channel'):
       ...
       embed_m.add_field(name="<a:bubblerf:935756938661232690> Server Information; <a:bubblerf:935756938661232690>",
                         value=':burst1: No discrimination, Bullying, etc.\n\n:burst1: Attacking any members based on sexuality, race, etc is not allowed.\n\n- Men I Trust Roles:\n\n:burst4: <@&924152053150920764> - Owner\n\n:burst4: <@&931682984568979537> - Co-Owner\n\n:burst4: <@&924156949401047061> - Official Band Members\n\n:burst4: <@&749401066428170298> - Boosters within the server\n\nThanks so much! ~ Oncle <a:heartwonclejazz:931061570920931368>')
