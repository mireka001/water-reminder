...
#embed(s):
    ...
    if message.content.lower().strip().startswith(';roles2'):
       embed_m = discord.Embed(colour=0x000000)
       embed_m.add_field(name="<3",
                         value='<a:blackarrow:967236196818382939> <@&959577017072881714>\n\n<a:blackarrow:967236196818382939> <@&959587688086917233>\n\n<a:blackarrow:967236196818382939> <@&959576872717541387>\n\n<a:blackarrow:967236196818382939> <@&959576971455643708>\n\n<a:blackarrow:967236196818382939> <@&959577150393057290>')
