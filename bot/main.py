...
async def on_message(message):
    ...
    if message.content.lower().strip().startswith('.channel'):
       ...
       embed_m.set_thumbnail(url="https://media0.giphy.com/media/Kg9JwOFEyoK75CzQSK/giphy.gif?cid=6c09b952j0ct9kb6i79nwh9q8wxqqync0xj0zmaho29wvegg&rid=giphy.gif&ct=s")
       time.sleep(2)
